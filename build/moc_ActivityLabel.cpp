...
static const char qt_meta_stringdata_ActivityLabel[] = {
    "ActivityLabel\0\0clicked()\0"
};
...
const QMetaObjectExtraData ActivityLabel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ActivityLabel::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_ActivityLabel,
      qt_meta_data_ActivityLabel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ActivityLabel::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ActivityLabel))
